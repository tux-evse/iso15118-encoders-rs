...
pub struct CableCheckRequest {
    payload: cglue::din_CableCheckReqType,
}

impl CableCheckRequest {
    pub fn new(status: &DcEvStatusType) -> Self {
        let mut payload = unsafe { mem::zeroed::<cglue::din_CableCheckReqType>() };
        payload.DC_EVStatus = status.encode();
        Self { payload }
    }

    pub fn decode(payload: cglue::din_CableCheckReqType) -> Self {
        Self { payload }
    }
...
impl CableCheckResponse {
    ...
    pub fn decode(payload: cglue::din_CableCheckResType) -> Self {
        Self { payload }
    }
