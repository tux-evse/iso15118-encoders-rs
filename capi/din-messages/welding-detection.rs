...
pub struct WeldingDetectionRequest {
    payload: cglue::din_WeldingDetectionReqType,
}
impl WeldingDetectionRequest {
    pub fn new(status: &DcEvStatusType) -> Self {
        let mut payload = unsafe { mem::zeroed::<cglue::din_WeldingDetectionReqType>() };
    ...
    pub fn decode(payload: cglue::din_WeldingDetectionReqType) -> Self {
        Self { payload }
    }
...
pub struct WeldingDetectionResponse {
    payload: cglue::din_WeldingDetectionResType,
}
...
impl WeldingDetectionResponse {
    ...
    pub fn decode(payload: cglue::din_WeldingDetectionResType) -> Self {
        Self { payload }
    }
