...
pub struct ServiceDetailRequest {
    payload: cglue::din_ServiceDetailReqType,
}

impl ServiceDetailRequest {
    pub fn new(service_id: u16) -> Self {
        let mut payload = unsafe { mem::zeroed::<cglue::din_ServiceDetailReqType>() };
        payload.ServiceID = service_id;
        Self { payload }
    }

    pub fn decode(payload: cglue::din_ServiceDetailReqType) -> Self {
        Self { payload }
    }
...
pub struct ServiceDetailResponse {
    payload: cglue::din_ServiceDetailResType,
}

impl ServiceDetailResponse {
    pub fn new(service_id: u16, code: ResponseCode) -> Self {
        let mut payload = unsafe { mem::zeroed::<cglue::din_ServiceDetailResType>() };
        payload.ServiceID = service_id;
    ...
    pub fn add_pset(&mut self, prm_set: &ParamSet) -> Result<&mut Self, AfbError> {
        ...
        if idx == cglue::din_ParameterSetType_5_ARRAY_SIZE as u16 {
    ...
    pub fn decode(payload: cglue::din_ServiceDetailResType) -> Self {
        Self { payload }
    }
